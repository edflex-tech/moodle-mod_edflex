 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class adhoc_synchronize_categories_task extends adhoc_task {
    /**
    ...
    /**
     * Retrieves a singleton client instance. If the client instance does not already exist,
     * it is created using the configuration settings.
     *
    ...
    /**
     * Provides an instance of the category manager, instantiating it if not already initialized.
     *
     * @return category_manager The category manager instance.
     */
